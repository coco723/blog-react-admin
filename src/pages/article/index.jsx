...
import { Card, Form, Input, Row, Col, Button, Badge, Modal, Tag, Divider } from 'antd';
      ...
      },
      {
        ...
        render: (text, record) => (
          <div>
            ...
            <Divider type="vertical" />
            <Fragment>
              <a href={`${blogDomain}articleDetail?article_id=${record._id}`} target="_blank">
                详情
              </a>
            </Fragment>
            <Divider type="vertical" />
